...
data[hex.terrain_prob, terrain.grass] = 6000;
data[hex.terrain_prob, terrain.forest] = 2000;
data[hex.terrain_prob, terrain.swamp] = 500;
data[hex.terrain_prob, terrain.desert] = 500;
data[hex.terrain_prob, terrain.mountain] = 500;
data[hex.terrain_prob, terrain.water] = 500;
data[hex.terrain_type] = terrain.na;
data[hex.building_seed] = 0;
data[hex.building_bool] = false;
/* data[hex.building_prob] = []; */
data[hex.building_prob, building.na] = 10000;
